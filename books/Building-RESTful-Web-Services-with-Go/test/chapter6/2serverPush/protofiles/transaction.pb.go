...
const file_transaction_proto_rawDesc = "" +
	...
	"\x06amount\x18\x03 \x01(\x02R\x06amount\"c\n" +
	"\x13TransactionResponse\x12\x16\n" +
	"\x06status\x18\x01 \x01(\tR\x06status\x12\x12\n" +
	"\x04step\x18\x02 \x01(\x05R\x04step\x12 \n" +
	"\vdescription\x18\x03 \x01(\tR\vdescription2j\n" +
	"\x10MoneyTransaction\x12V\n" +
	"\x0fMakeTransaction\x12\x1e.protofiles.TransactionRequest\x1a\x1f.protofiles.TransactionResponse\"\x000\x01B\x0eZ\f.;protofilesb\x06proto3"
