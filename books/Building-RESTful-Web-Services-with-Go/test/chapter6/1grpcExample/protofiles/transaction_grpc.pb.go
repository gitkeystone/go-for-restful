...
const (
	MoneyTransaction_MakeTransaction_FullMethodName = "/protofiles.MoneyTransaction/MakeTransaction"
)
...
func (c *moneyTransactionClient) MakeTransaction(ctx context.Context, in *TransactionRequest, opts ...grpc.CallOption) (*TransactionResponse, error) {
	...
	err := c.cc.Invoke(ctx, MoneyTransaction_MakeTransaction_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
// UnimplementedMoneyTransactionServer must be embedded to have
...
func (UnimplementedMoneyTransactionServer) MakeTransaction(context.Context, *TransactionRequest) (*TransactionResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method MakeTransaction not implemented")
}
