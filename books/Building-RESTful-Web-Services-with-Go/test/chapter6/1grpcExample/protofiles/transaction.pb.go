...
const file_transaction_proto_rawDesc = "" +
	...
	"\x06amount\x18\x03 \x01(\x02R\x06amount\"9\n" +
	"\x13TransactionResponse\x12\"\n" +
	"\fconfirmation\x18\x01 \x01(\bR\fconfirmation2h\n" +
	"\x10MoneyTransaction\x12T\n" +
	"\x0fMakeTransaction\x12\x1e.protofiles.TransactionRequest\x1a\x1f.protofiles.TransactionResponse\"\x00B\x0eZ\f.;protofilesb\x06proto3"
