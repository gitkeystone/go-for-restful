...
const file_encryption_proto_rawDesc = "" +
	...
	"\tEncrypter\x126\n" +
	"\aEncrypt\x12\x13.protofiles.Request\x1a\x14.protofiles.Response\"\x00\x126\n" +
	"\aDecrypt\x12\x13.protofiles.Request\x1a\x14.protofiles.Response\"\x00B\x0eZ\f.;protofilesb\x06proto3"
...
var file_encryption_proto_msgTypes = make([]protoimpl.MessageInfo, 2)
...
var file_encryption_proto_depIdxs = []int32{
	0, // 0: protofiles.Encrypter.Encrypt:input_type -> protofiles.Request
	0, // 1: protofiles.Encrypter.Decrypt:input_type -> protofiles.Request
	1, // 2: protofiles.Encrypter.Encrypt:output_type -> protofiles.Response
	1, // 3: protofiles.Encrypter.Decrypt:output_type -> protofiles.Response
